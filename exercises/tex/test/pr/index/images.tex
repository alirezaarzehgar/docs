...
{\newpage\clearpage
\lthtmlfigureA{frame20}%
\begin{frame}
% latex2html id marker 20

		\begin{figure}
			\centering\includegraphics[width=0.7\linewidth]{../../../myface}
			\caption{sss}
		\end{figure}
	\end{frame}%
\lthtmlfigureZ
